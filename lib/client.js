  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require, module, exports) {
      ...
      function WhaleOverlay() {
        ...
        // CSS motion is the placeholder's stand-in; a real sprite animates itself.
        const style = {
          position: 'fixed',
        ...
        return h('div', { style, className: 'whale-on-desk' + (file ? '' : ' ' + stateClass(state)) },
          menuOpen ? h('div', {
            style: {
          ...
          h('div', {
            onPointerDown, onPointerMove, onPointerUp, onClick, onDoubleClick, onContextMenu,
